...
do the following:
  ...
  5. Issue the following command: `vasm6502_oldstyle.exe -dotdir -Fbin -o smon.bin smon.asm` for WIN or './vasm6502_oldstyle.exe -dotdir -Fbin -o smon.bin smon.asm' for MAC.
